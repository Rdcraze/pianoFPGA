...
module phase0_audio_path (
    ...
    input  wire [15:0] voice0_velocity,
    input  wire [6:0]  voice0_loop_len,
    input  wire [15:0] voice1_velocity,
    input  wire [6:0]  voice1_loop_len,
    input  wire [15:0] voice2_velocity,
    input  wire [6:0]  voice2_loop_len,
    input  wire [15:0] voice3_velocity,
    input  wire [6:0]  voice3_loop_len,
...
phase1_reduced_voice phase1_reduced_voice_inst (
    ...
    .velocity_q15     (voice0_velocity),
    .loop_len         (voice0_loop_len),
...
phase1_reduced_voice phase1_reduced_voice1_inst (
    ...
    .body_bypass      (voice_body_bypass),
    .disp_bypass      (voice_disp_bypass),
    .velocity_q15     (voice1_velocity),
    .loop_len         (voice1_loop_len),
    .loop_gain_q15    (voice_loop_gain),
    .damp_mix_q15     (voice_damp_mix),
    .disp_coeff_q15   (voice_disp_coeff),
    .body_mix_q15     (voice_body_mix),
...
phase1_reduced_voice phase1_reduced_voice2_inst (
    ...
    .body_bypass      (voice_body_bypass),
    .disp_bypass      (voice_disp_bypass),
    .velocity_q15     (voice2_velocity),
    .loop_len         (voice2_loop_len),
    .loop_gain_q15    (voice_loop_gain),
    .damp_mix_q15     (voice_damp_mix),
    .disp_coeff_q15   (voice_disp_coeff),
    .body_mix_q15     (voice_body_mix),
...
phase1_reduced_voice phase1_reduced_voice3_inst (
    ...
    .body_bypass      (voice_body_bypass),
    .disp_bypass      (voice_disp_bypass),
    .velocity_q15     (voice3_velocity),
    .loop_len         (voice3_loop_len),
    .loop_gain_q15    (voice_loop_gain),
    .damp_mix_q15     (voice_damp_mix),
    .disp_coeff_q15   (voice_disp_coeff),
    .body_mix_q15     (voice_body_mix),
