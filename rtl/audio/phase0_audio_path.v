...
assign sample_valid_any = voice0_sample_valid || voice1_sample_valid || voice2_sample_valid;
assign active_any       = voice0_active || voice1_active || voice2_active;
assign excite_busy_any  = voice0_excite_busy || voice1_excite_busy || voice2_excite_busy;
...
assign mix_sum          = voice0_mix_ext + voice1_mix_ext + voice2_mix_ext;
assign mix_clip_now     = (mix_sum > 18'sd32767) || (mix_sum < -18'sd32768);
assign mix_sample_sat   = (mix_sum > 18'sd32767)  ? 16'sh7fff :
                          (mix_sum < -18'sd32768) ? 16'sh8000 :
                          mix_sum[15:0];
...
assign status_word = {
    3'd0,
    voice_enable,
    voice0_clip_seen || voice1_clip_seen || voice2_clip_seen || voice_mix_clip_seen_reg,
    excite_busy_any,
    wave_sel,
    3'd0,
    audio_enable,
