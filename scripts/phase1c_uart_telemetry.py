...
STARTUP_TAGS = ("I", "S", "R")
MEASUREMENT_TAGS = ("CC",)
VOICE3_DIAG_TAGS = ("V3", "VT", "VA", "VV")
M2_STEAL_TAGS = ("ST",)
VOICE3_SCHEDULER_TAGS = ("S3",)
KNOWN_TAGS = set(STARTUP_TAGS + VOICE_DIAG_TAGS + SCHEDULER_TAGS + MEASUREMENT_TAGS + VOICE3_DIAG_TAGS + VOICE3_SCHEDULER_TAGS + M2_STEAL_TAGS)
