...
#define PHASE0_REG_VOICE3_CONTROL        0x84u
#define PHASE0_REG_VOICE3_STATUS         0x88u
#define PHASE0_REG_VOICE3_TRIGGER_COUNT  0x8Cu
#define PHASE0_REG_VOICE3_ACTIVE_COUNT   0x90u
#define PHASE0_REG_VOICE3_VALID_COUNT    0x94u

#define PHASE0_VOICE3_CONTROL_ENABLE_M     (1u << 0)
#define PHASE0_VOICE3_CONTROL_TRIGGER_M    (1u << 1)
#define PHASE0_VOICE3_CONTROL_RESET_M      (1u << 2)
#define PHASE0_VOICE3_CONTROL_CLIP_CLEAR_M (1u << 8)

#define PHASE0_REG_VOICE0_LOOP_LEN        0x98u
#define PHASE0_REG_VOICE0_VELOCITY        0x9Cu
#define PHASE0_REG_VOICE1_LOOP_LEN        0xA0u
#define PHASE0_REG_VOICE1_VELOCITY        0xA4u
#define PHASE0_REG_VOICE2_LOOP_LEN        0xA8u
#define PHASE0_REG_VOICE2_VELOCITY        0xACu
#define PHASE0_REG_VOICE3_LOOP_LEN        0xB0u
#define PHASE0_REG_VOICE3_VELOCITY        0xB4u
...
#define PHASE0_VOICE_DEFAULT_VELOCITY      0x7FFFu
...
#define PHASE0_VOICE_DEFAULT_BODY_MIX      16384u
